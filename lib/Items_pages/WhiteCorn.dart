...
class WhiteCorn extends StatefulWidget {
  const WhiteCorn({super.key});

  @override
  State<WhiteCorn> createState() => _WhiteCornState();
}

class _WhiteCornState extends State<WhiteCorn> {
  ...
  Future<void> _saveData() async {
    ...
    await prefs.setDouble('totalStock', totalStock);
    await prefs.setDouble('totalReceived', totalReceived);
    await prefs.setDouble('totalDispatched', totalDispatched);
    await prefs.setInt('currentYear', currentYear);
    await prefs.setInt('currentMonthNumber', currentMonthNumber);
  }
